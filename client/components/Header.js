...
const Header = ({ 
  ...
  const { isConnected, account, balance, connectWallet, disconnectWallet } = useHedera();
          ...
          <div className="flex items-center space-x-4">
            ...
            {showAuth && isAuthenticated && user ? (
                      ...
                      {authNavigation
                        ...
                        .map((item) => (
                          <Link
                            key={item.name}
                            to={item.href}
                            onClick={() => handleUserAction(item.name.toLowerCase())}
              ...
              <div className="hidden md:flex items-center space-x-3">
                ...
                <button
                  onClick={() => navigate('/institutions/login')}
