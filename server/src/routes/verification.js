...
router.post('/verify-credential', 
  ...
  asyncHandler(async (req, res, next) => {
    ...
    if (result.valid && result.credential?.metadata?.attributes?.university) {
      const university = await User.findOne({ where: { universityName: result.credential.metadata.attributes.university } });
      if (university) {
            ...
            ${result.valid && result.credential ? `
              <div class="credential-info">
                ...
                <div class="field">
                  ...
                  <span class="value">${result.credential.metadata.attributes.studentName}</span>
                </div>
                <div class="field">
                  <span class="label">University:</span>
                  <span class="value">${result.credential.metadata.attributes.university}</span>
                </div>
                <div class="field">
                  <span class="label">Degree:</span>
                  <span class="value">${result.credential.metadata.attributes.degree}</span>
                </div>
                <div class="field">
                  <span class="label">Graduation Date:</span>
                  <span class="value">${result.credential.metadata.attributes.graduationDate}</span>
                </div>
                <div class="field">
                  <span class="label">GPA:</span>
                  <span class="value">${result.credential.metadata.attributes.gpa}</span>
                </div>
                <div class="field">
                  <span class="label">Issued Date:</span>
                  <span class="value">${new Date(result.credential.metadata.attributes.issuedDate).toLocaleDateString()}</span>
                </div>
                <div class="field">
