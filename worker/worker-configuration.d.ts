/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be048350256243c9adad78b983819d7b)
// Runtime types generated with workerd@1.20260301.1 2024-04-05 
declare namespace Cloudflare {
	interface Env {
		academic_db: D1Database;
		VITE_API_URL: "https://academicchain-worker.aether-connect-labs.workers.dev";
		NODE_ENV: string;
		PORT: string;
		API_URL: string;
		CLIENT_URL: string;
		...
		HEDERA_NFT_COLLECTION_ID: string;
		...
		ENABLE_XRP_PAYMENTS: string;
		XRPL_MINT_FEE_XRP: string;
		REQUEST_TIMEOUT: string;
		RATE_ORACLE_TIMEOUT_MS: string;
		HEDERA_TIMEOUT_MS: string;
		XRPL_TIMEOUT_MS: string;
		REDIS_TIMEOUT_MS: string;
		MONGO_TIMEOUT_MS: string;
		EXTERNAL_API_TIMEOUT_MS: string;
		SOCKET_HEARTBEAT_TIMEOUT_MS: string;
		API_REQUEST_TIMEOUT_MS: string;
		XRPL_ENABLE: string;
		XRPL_NETWORK: string;
		XRPL_SEED: string;
		XRPL_ADDRESS: string;
		XRP_ANCHOR_FEE: string;
		XRP_BACKUP_WALLET: string;
